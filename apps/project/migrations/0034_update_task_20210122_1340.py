# Generated by Django 3.0.8 on 2021-01-22 04:40
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('project', '0033_update_protype_20210122_1321'),
    ]
    ...
    taskList=[
        ...
        ["양산 프로세스 설계 및 업체 수배",8,9,"양산 프로세스 설계 및 업체 수배8-9주차, 기구설계 제품","PM"],
        ["양산 프로세스 설계 및 업체 수배",9,10,"양산 프로세스 설계 및 업체 수배9-10주차, 디자인/기구설계 제품","PM"],
        ["양산 프로세스 설계 및 업체 수배",14,15,"양산 프로세스 설계 및 업체 수배14-15주차, 디자인/회로/기구설계 제품","PM"],
    ]
